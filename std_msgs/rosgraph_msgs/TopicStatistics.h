...
struct TopicStatistics_
{
  ...
  _node_sub_type node_sub;
   ...
   typedef xcros::Time _window_start_type;
  _window_start_type window_start;

   typedef xcros::Time _window_stop_type;
  ...
  _traffic_type traffic;
   ...
   typedef xcros::Duration _period_mean_type;
  _period_mean_type period_mean;

   typedef xcros::Duration _period_stddev_type;
  _period_stddev_type period_stddev;

   typedef xcros::Duration _period_max_type;
  _period_max_type period_max;

   typedef xcros::Duration _stamp_age_mean_type;
  _stamp_age_mean_type stamp_age_mean;

   typedef xcros::Duration _stamp_age_stddev_type;
  _stamp_age_stddev_type stamp_age_stddev;

   typedef xcros::Duration _stamp_age_max_type;
...
{
xcros::message_operations::Printer< ::rosgraph_msgs::TopicStatistics_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
// {'rosgraph_msgs': ['/home/xuchen/ros_catkin_ws/src/ros_comm_msgs/rosgraph_msgs/msg'], 'std_msgs': ['/home/xuchen/ros_catkin_ws/install_isolated/share/std_msgs/cmake/../msg']}
...
struct Printer< ::rosgraph_msgs::TopicStatistics_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::rosgraph_msgs::TopicStatistics_<ContainerAllocator>& v)
  {
    ...
    Printer<xcros::Time>::stream(s, indent + "  ", v.window_start);
    s << indent << "window_stop: ";
    Printer<xcros::Time>::stream(s, indent + "  ", v.window_stop);
    ...
    Printer<xcros::Duration>::stream(s, indent + "  ", v.period_mean);
    s << indent << "period_stddev: ";
    Printer<xcros::Duration>::stream(s, indent + "  ", v.period_stddev);
    s << indent << "period_max: ";
    Printer<xcros::Duration>::stream(s, indent + "  ", v.period_max);
    s << indent << "stamp_age_mean: ";
    Printer<xcros::Duration>::stream(s, indent + "  ", v.stamp_age_mean);
    s << indent << "stamp_age_stddev: ";
    Printer<xcros::Duration>::stream(s, indent + "  ", v.stamp_age_stddev);
    s << indent << "stamp_age_max: ";
    Printer<xcros::Duration>::stream(s, indent + "  ", v.stamp_age_max);
  }
};
