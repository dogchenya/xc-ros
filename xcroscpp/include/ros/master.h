 ...
 */
ROSCPP_DECL bool execute(const std::string& method, const RobotRpc::XmlRpcValue& request, RobotRpc::XmlRpcValue& response, RobotRpc::XmlRpcValue& payload, bool wait_for_master);
 ...
 */
ROSCPP_DECL void setRetryTimeout(xcros::WallDuration timeout);
