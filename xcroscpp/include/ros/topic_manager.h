#ifndef _XCROSCPP_TOPIC_MANAGER_H_
...
private:
     ...
     */
    bool requestTopic(const std::string &topic, RobotRpc::XmlRpcValue &protos, RobotRpc::XmlRpcValue &ret);
     ...
     */
    void getBusStats(RobotRpc::XmlRpcValue &stats);
     ...
     */
    void getBusInfo(RobotRpc::XmlRpcValue &info);
     ...
     */
    void getSubscriptions(RobotRpc::XmlRpcValue &subscriptions);
     ...
     */
    void getPublications(RobotRpc::XmlRpcValue &publications);
    ...
    void pubUpdateCallback(RobotRpc::XmlRpcValue& params, RobotRpc::XmlRpcValue& result);
    void requestTopicCallback(RobotRpc::XmlRpcValue& params, RobotRpc::XmlRpcValue& result);
    void getBusStatsCallback(RobotRpc::XmlRpcValue& params, RobotRpc::XmlRpcValue& result);
    void getBusInfoCallback(RobotRpc::XmlRpcValue& params, RobotRpc::XmlRpcValue& result);
    void getSubscriptionsCallback(RobotRpc::XmlRpcValue& params, RobotRpc::XmlRpcValue& result);
    void getPublicationsCallback(RobotRpc::XmlRpcValue& params, RobotRpc::XmlRpcValue& result);
