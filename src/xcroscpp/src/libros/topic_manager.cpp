...
using namespace RobotRpc; // A battle to be fought later
...
void TopicManager::start()
{
  ...
  robotrpc_manager_ = RobotRPCManager::Instance();

  robotrpc_manager_->bind("publisherUpdate", boost::bind(&TopicManager::pubUpdateCallback, this, _1, _2));
  robotrpc_manager_->bind("requestTopic", boost::bind(&TopicManager::requestTopicCallback, this, _1, _2));
  robotrpc_manager_->bind("getBusStats", boost::bind(&TopicManager::getBusStatsCallback, this, _1, _2));
  robotrpc_manager_->bind("getBusInfo", boost::bind(&TopicManager::getBusInfoCallback, this, _1, _2));
  robotrpc_manager_->bind("getSubscriptions", boost::bind(&TopicManager::getSubscriptionsCallback, this, _1, _2));
  robotrpc_manager_->bind("getPublications", boost::bind(&TopicManager::getPublicationsCallback, this, _1, _2));
...
void TopicManager::shutdown()
{
  ...
  robotrpc_manager_->unbind("publisherUpdate");
  robotrpc_manager_->unbind("requestTopic");
  robotrpc_manager_->unbind("getBusStats");
  robotrpc_manager_->unbind("getBusInfo");
  robotrpc_manager_->unbind("getSubscriptions");
  robotrpc_manager_->unbind("getPublications");
...
bool TopicManager::advertise(const AdvertiseOptions& ops, const SubscriberCallbacksPtr& callbacks)
{
  ...
  args[1] = ops.topic;
  args[2] = ops.datatype;
  args[3] = robotrpc_manager_->getServerURI();
...
bool TopicManager::unregisterPublisher(const std::string& topic)
{
  ...
  args[0] = this_node::getName();
  args[1] = topic;
  args[2] = robotrpc_manager_->getServerURI();
...
bool TopicManager::registerSubscriber(const SubscriptionPtr& s, const string &datatype)
{
  ...
  {
    if (payload[i] != robotrpc_manager_->getServerURI())
    {
...
void TopicManager::pubUpdateCallback(RobotRpc::XmlRpcValue& params, RobotRpc::XmlRpcValue& result)
{
  ...
  {
    result = robotrpc::responseInt(0, console::g_last_error_message, 0);
  }
}

void TopicManager::requestTopicCallback(RobotRpc::XmlRpcValue& params, RobotRpc::XmlRpcValue& result)
{
...
void TopicManager::getBusStatsCallback(RobotRpc::XmlRpcValue& params, RobotRpc::XmlRpcValue& result)
{
  (void)params;
  result[0] = 1;
  result[1] = std::string("");
...
void TopicManager::getBusInfoCallback(RobotRpc::XmlRpcValue& params, RobotRpc::XmlRpcValue& result)
{
  (void)params;
  result[0] = 1;
  result[1] = std::string("");
...
void TopicManager::getSubscriptionsCallback(RobotRpc::XmlRpcValue& params, RobotRpc::XmlRpcValue& result)
{
  (void)params;
  result[0] = 1;
...
void TopicManager::getPublicationsCallback(RobotRpc::XmlRpcValue& params, RobotRpc::XmlRpcValue& result)
{
  (void)params;
  result[0] = 1;
