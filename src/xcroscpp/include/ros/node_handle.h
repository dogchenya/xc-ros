#ifndef _XCROSCPP_NODE_HANDLE_H_
#define _XCROSCPP_NODE_HANDLE_H_
...
\endverbatim
   ...
   */
  void setParam(const std::string& key, const RobotRpc::XmlRpcValue& v) const;
   ...
   * \throws InvalidNameException If the parameter key begins with a tilde, or is an otherwise invalid graph resource name
   */
  bool getParam(const std::string& key, RobotRpc::XmlRpcValue& v) const;
   ...
   * \throws InvalidNameException If the parameter key begins with a tilde, or is an otherwise invalid graph resource name
   */
  bool getParamCached(const std::string& key, RobotRpc::XmlRpcValue& v) const;
