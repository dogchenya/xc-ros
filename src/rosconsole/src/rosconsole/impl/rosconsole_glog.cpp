...
void print(void* handle, ::xcros::console::Level level, const char* str, const char* file, const char* function, int line)
{
  ...
  ::xcros::console::backend::print(0, level, str, file, function, line);
  ...
  if(level == ::xcros::console::levels::Info)
  {
...
void* getHandle(const std::string& name)
{
  ...
  rosconsole_glog_log_levels.push_back(std::pair<std::string, levels::Level>(name, ::xcros::console::levels::Info));
