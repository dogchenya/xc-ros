...
struct Clock_
{
  ...
  (void)_alloc;
   ...
   typedef xcros::Time _clock_type;
  _clock_type clock;
...
{
xcros::message_operations::Printer< ::rosgraph_msgs::Clock_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
struct Printer< ::rosgraph_msgs::Clock_<ContainerAllocator> >
{
  ...
  {
    s << indent << "clock: ";
    Printer<xcros::Time>::stream(s, indent + "  ", v.clock);
  }
};
