...
struct Header_
{
  ...
  _seq_type seq;
   ...
   typedef xcros::Time _stamp_type;
  _stamp_type stamp;
...
{
xcros::message_operations::Printer< ::std_msgs::Header_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
// {'std_msgs': ['/home/xuchen/ros_catkin_ws/src/std_msgs/msg']}
