...
#ifndef _XCROS_CORE_MESSAGE_EVENT_H_
#define _XCROS_CORE_MESSAGE_EVENT_H_
...
public:
  ...
  void init(const ConstMessagePtr& message, const boost::shared_ptr<M_string>& connection_header, xcros::Time receipt_time, bool nonconst_need_copy, const CreateFunction& create)
  {
    message_ = message;
   ...
   */
  xcros::Time getReceiptTime() const { return receipt_time_; }
